...
#ifndef __MM32G0001A_FEATURES_H__
#define __MM32G0001A_FEATURES_H__

#include "mm32g0001a.h"
...
#define TIM_CR2_OIS15_SHIFT                    (16)
#define TIM_CR2_OIS15_MASK                     (0x01U << TIM_CR2_OIS15_SHIFT)
#define TIM_CR2_OIS15(x)                       (((uint32_t)(((uint32_t)(x)) << TIM_CR2_OIS15_SHIFT)) & TIM_CR2_OIS15_MASK)
...
/* Reserved, TIM_CCER_CC4NE is invalid in F0040, just for adapting hal_tim. */
...
/*!
 * @brief ADC Register Bit Definition
 * these register definition not be used in mm32f0020
 */
#define ADC_ADCR_EOSIE_MASK                     ADC_ADCR_ADIE_MASK
#define ADC_ADSTA_EOSIF_MASK                    ADC_ADSTA_ADIF_MASK
#endif  /* __MM32G0001A_FEATURES_H__ */
