 ...
 */
#define SPI_DRIVER_VERSION 2u /*!< spi_2. */

/*!
 * @addtogroup SPI_STATUS
 * @{
 */
#define SPI_STATUS_BUSY         SPI_CSTAT_BUSY_MASK       /*!< Status flag when SPI is transmitting or receiving. */
#define SPI_STATUS_TX_EMPTY     SPI_CSTAT_TXEPT_MASK      /*!< Status flag when SPI transmiter buffer is empty. */
#define SPI_STATUS_RX_DONE      SPI_CSTAT_RXAVL_MASK      /*!< Status flag when SPI receiving buffer is with available data. */
#define SPI_STATUS_TX_FULL      SPI_CSTAT_TXFULL_MASK     /*!< Status flag when SPI transmiter buffer is full. */
/*!
 * @}
 */
 ...
 * @{
 */
#define SPI_INT_TX_DONE         SPI_INTEN_TXIEN_MASK         /*!< Interrupt enable when SPI transmiter buffer has started sending data. */
#define SPI_INT_RX_DONE         SPI_INTEN_RXIEN_MASK         /*!< Interrupt enable when SPI receiving buffer is with available data. */
#define SPI_INT_TX_UNDERRUN     SPI_INTEN_UNDERRUNIEN_MASK   /*!< Interrupt enable when SPI transmiter transmit empty data. */
#define SPI_INT_RX_OVERRUN      SPI_INTEN_RXOERRIEN_MASK     /*!< Interrupt enable when SPI receive data using the full buffer. */
#define SPI_INT_RX_MATCH        SPI_INTEN_RXMATCHIEN_MASK    /*!< Interrupt enable when SPI receiving buffer match the width set in RXDNR. */
#define SPI_INT_RX_FULL         SPI_INTEN_RXFULLIEN_MASK     /*!< Interrupt enable when SPI receiving buffer is full. */
#define SPI_INT_TX_EMPTY        SPI_INTEN_TXEPTIEN_MASK      /*!< Interrupt enable when SPI transmiter buffer is empty. */
/*!
 * @}
 */
