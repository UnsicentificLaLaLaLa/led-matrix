 ...
 */
#define ADC_DRIVER_VERSION 3u /*!< adc_3. */
...
#define ADC_STATUS_CONV_SEQ_DONE        (1u << 0u) /*!< Status flag when ADC sequence conversion done. */
#define ADC_STATUS_CONV_COMPARE_DONE    (1u << 1u) /*!< Status flag when the ADC conversion result is compared with the set value. */
...
#define ADC_INT_CONV_SEQ_DONE           (1u << 0u)  /*!< Interrupt enable when ADC sequence conversion done. */
#define ADC_INT_CONV_COMPARE_DONE       (1u << 1u)  /*!< Interrupt enable when ADC the ADC conversion result is compared with the set value. */
...
/*!
 * @brief Configuration all channel sample time of the ADC module.
 *
 * @param ADCx ADC instance.
